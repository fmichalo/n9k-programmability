...
#            print ("RAW_OUTPUT: " + self.raw_output)
...
#            print ("RSA:\n%s\n\nDSA:\n%s" % (self.raw_rsa_output, self.raw_dsa_output))
    ...
    def _parse_keys(self, raw_text):
        ...
        # Todo: need to fix this.  Fingerprint show on next line
        #this_key["fingerprints"]    = re.findall('fingerprint:', raw_text)
        return this_key
